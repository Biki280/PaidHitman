...
TOKEN =("7942484076:AAGxnxJlmT69Qp62oMjRU3LBnx0mlIv6XMg")
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002477726768
CHANNEL_ID = -1002477726768
error_channel_id = -1002477726768
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @DExKRAKEN.*", parse_mode='Markdown')  # Contact owner message
            return
